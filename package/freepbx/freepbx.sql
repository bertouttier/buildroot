...
CREATE INDEX id ON devices (id);
CREATE INDEX tech ON devices (tech);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE INDEX enabled ON featurecodes (enabled);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `freepbx_log` (
  ...
  `level` TEXT CHECK( `level` IN ('error','warning','debug','devel-debug') ) NOT NULL DEFAULT 'error',
  `status` int(11) NOT NULL DEFAULT '0',
  `message` text NOT NULL
);
CREATE INDEX `time` ON `freepbx_log` (`time`, `level`);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE INDEX extension ON users (extension);
/*!40101 SET character_set_client = @saved_cs_client */;

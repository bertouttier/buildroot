...
# $(ASTERISK_DIR)/.configured: $(ASTERISK_DIR)/.patched | host-automake host-pkgconf host-ncurses host-bison host-flex host-libxml2 \
# 			elfutils ncurses zlib openssl libtool util-linux $(ASTERISK_EXTRAS)
